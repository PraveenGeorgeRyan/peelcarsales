  ...
  return (
    <nav className={styles.nav} aria-label="Main navigation — Peel Car Sales used car dealership Mississauga Oakville">
      ...
      <div className={styles.center}>
        <a href="tel:9056780048" className={styles.contactBlock}>
          ...
          <div>
            <div className={styles.contactLabel}>Call Us Now</div>
            <div className={styles.contactValue}>905-678-0048</div>
          </div>
        </a>
        ...
        <div className={styles.contactBlock}>
          <div className={`${styles.contactIcon} ${styles.pinIcon}`}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <div className={styles.contactValue}>2701 Derry Road East Mississauga, Ontario, L4T 1A2</div>
            <div className={styles.contactValue}>333 Wyecroft Road, Unit 11, Oakville, ON, L6K 2H2</div>
          </div>
        </div>
