...
const features = [
  "We beat any written competitor offer",
  "No need to buy from us — sell outright",
  "Same-day cash or cheque available",
  "Trade in and upgrade your vehicle in one visit",
    ...
    <section className={styles.tradein} id="tradein" aria-label="Sell or trade in your car in Mississauga and Oakville">
      <div>
        ...
        <p className={styles.desc}>
          ...
          Any condition. Any kilometre count. Any make or model. Get a <strong>cash offer within 24 hours</strong> — no obligation to buy
          from us. We serve Toronto, Brampton, Burlington, and all of the Greater Toronto Area.
        </p>
